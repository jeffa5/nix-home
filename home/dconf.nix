...
in {
  dconf.settings = {
    ...
    "org/gnome/shell" = {
      ...
      favorite-apps = ["firefox.desktop" "org.gnome.Console.desktop" "slack.desktop" "thunderbird.desktop" "todoist-electron.desktop" "spotify.desktop" "signal-desktop.desktop"];
